...
async def start_command(client: Client, message: Message):
    ...
    owner_id = ADMINS + ['5845177357']  # Fetch the owner's ID from config
    ...
    if id == owner_id:
        ...
        if "verify_" in message.text:
            ...
            if IS_VERIFY and not verify_status['is_verified']:
                ...
                link = await get_shortlink(SHORTLINK_URL, f'https://telegram.dog/{client.username}?start=verify_878a63c78eace314afb66b9c4310f9a81193a6b8')
                btn = [
